...
const House_RecordsModel = require('./House_Record')(sequelize, DataTypes);
const House_StatisticsModel = require('./House_Statistic')(sequelize, DataTypes);
...
module.exports = {
    ...
    HouseModel, House_typeModel, House_StatisticsModel, GenderModel, House_typeModel, FeedbackModel, 
    EvictionModel, EmployeeModel, DepositModel, House_RecordsModel, UniversityModel, TenantModel,Tenant_HistoryModel, 
    StudentModel, StorageModel, RoomModel, RoomModel, Room_HistoryModel, PaymentModelModel, RoleModel, PaymentModelModel,
    RoleModel, RentModel, RegionModel, RegionModel, ReferralModel, Password_ResetModel, NationalityModel,
